...
public class SJAGUIController<T>
{
    ...
    private SJAWorldFrame<T> parentFrame;
     ...
     */
    public SJAGUIController(SJAWorldFrame<T> parent, SJAGridPanel disp,
    ...
    public void step()
    {
        ...
        //Is the match over?
        if ( SJAWorld.getRoundNum() > SJAWorld.NUM_ROUNDS_IN_MATCH )
        {
            stop();
        }
         ...
         */
        while(  consoleMode &&
                SJAWorld.getRoundNum() <= SJAWorld.NUM_ROUNDS_IN_MATCH && 
                SJAWorld.getMoveNum() < SJAWorld.NUM_MOVES_IN_ROUND )
        {
            parentFrame.getWorld().step();
        }
    ...
    private void makeControls()
    {
        ...
        consoleButton = new JButton("SuperFast");
