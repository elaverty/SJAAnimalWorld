...
public class World<T>
{
    ...
    /**
     * Constructs a new World based on a SJAGrid.  
     */
    public World()
    {
        this(new SJAGrid<T>(DEFAULT_ROWS, DEFAULT_COLS));
        message = null;
    }
    ...
    public void show()
    {
        if (frame == null)
        {
            frame = new SJAWorldFrame<T>(this);
